...
from .models import CustomUser, PatientProfile, DoctorProfile,PatientData,DoctorData,VitalHistoryPatient,VitalHistoryDoctor
...
admin.site.register(VitalHistoryPatient)
admin.site.register(VitalHistoryDoctor)
