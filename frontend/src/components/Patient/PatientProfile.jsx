...
const PatientProfile = () => {
  ...
  const [showWebcam, setShowWebcam] = useState(false); // *** START CHANGE: Added state to control webcam visibility ***
    ...
    <div className="bg-slate-100 min-h-screen flex flex-col">
      ...
      <div className="container mx-auto p-6 md:p-12 flex-grow">
        ...
        >
          ...
          {/* Profile Picture and Capture Now Section */}
            ...
            <div className="flex md:w-2/3 gap-4">
              ...
              {!showWebcam && (
                <button
                  id="activate-camera"
                  type="button"
                  onClick={() => setShowWebcam(true)} // Show webcam on click
                  className="py-3 px-4 rounded-md bg-white text-gray-700 border border-gray-300 shadow-sm hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 transition-all duration-200 ease-in-out flex items-center justify-center w-1/2"
                >
          ...
          {/*** END CHANGE: Align "Profile Picture" and "Capture Now" side by side ***/}



          {/*** END CHANGE: Align "Choose File" and "Activate Camera" side by side and center them ***/}
