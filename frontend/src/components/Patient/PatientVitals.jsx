...
//     try {
//       await axios.get("http://147.79.67.165:8000/api/users/patientprofile/", {
//         headers,
//       });
...
//     try {
//       const response = await axios.get(
//         "http://147.79.67.165:8000/api/users/patientvitals/history/",
//         { headers }
//       );
...
//     try {
//       const response = await axios.get(
//         "http://147.79.67.165:8000/api/users/patientvitals/",
//         { headers }
//       );
//       // Assuming there's only one item in the response array
...
const PatientVitals = () => {
  ...
  const fetchTemperature = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://147.79.67.165:8000/api/users/${userRole}vitals`,
        { headers }
      );
