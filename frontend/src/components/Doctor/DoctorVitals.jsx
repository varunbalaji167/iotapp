      ...
      {!profileExists ? (
        ...
        <>
          ...
          <div className="mt-6 space-y-8">
            <div className="p-4 md:p-6 lg:p-8 bg-gray-50 rounded-lg shadow-md transition hover:shadow-lg mb-6">
              <TempVitals
                deviceId={deviceId}
            ...
            <div className="p-4 md:p-6 lg:p-8 bg-gray-50 rounded-lg shadow-md transition hover:shadow-lg">
              <OximeterVitals
                deviceId={deviceId}
                profileExists={profileExists}
                devices={devices}
