...
const TempVitals = ({
  ...
  useEffect(() => {
    if (statusMessaget === "Reading Complete") {
      const timer = setTimeout(() => setStatusMessageT(""), 5000);
        ...
        <>
          <div className="mt-6">
            ...
            <button
              ...
              disabled={!connected || loadingt || !hardwareConfigured}
              className={`mt-2 py-2 px-6 rounded-md shadow-md transition duration-300 text-white ${
                !connected || loadingt || !hardwareConfigured
          ...
          {statusMessaget && <StatusMessage message={statusMessaget} />}
