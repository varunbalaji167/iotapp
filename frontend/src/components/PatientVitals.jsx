...
//     try {
//       const response = await axios.get("http://127.0.0.1:8000/api/users/patientvitals/", { headers });
...
//       <h1 className="text-3xl font-bold text-center mb-6">Patient Vitals</h1>
...
const PatientVitals = () => {
  ...
  // Check if the patient profile exists on component mount
  useEffect(() => {
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className={`mt-2 py-2 px-4 rounded-md ${
                !connected || loading ? "bg-gray-300" : "bg-blue-500"
              } text-white hover:bg-opacity-80 transition duration-300`}
            >
              {loading ? "Collecting..." : "Request Temperature"}
            </button>
